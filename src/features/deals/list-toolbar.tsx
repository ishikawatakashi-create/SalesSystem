...
function countAdvanced(query: DealListQuery): number {
  let n = 0;
  if (query.customerPageId) n += 1;
  if (query.stageId) n += 1;
  if (query.staffUserId) n += 1;
  if (query.expectedAmountMin != null) n += 1;
  if (query.expectedAmountMax != null) n += 1;
  if (query.expectedCloseDateFrom) n += 1;
  if (query.expectedCloseDateTo) n += 1;
